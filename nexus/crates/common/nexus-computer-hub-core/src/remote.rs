...
fn map_block(block: nexus_tool_protocol::McpBlock) -> ContentBlock {
    use nexus_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: nexus_tool_protocol::JsonRpcError) -> ToolError {
