...
impl ChatStateActor {
    ...
    /// Out-of-band history repair (`sage.local/session/repair`): run
        ...
        self.state
            ...
            .map(|item| match item {
                ...
                ConversationItem::Reasoning(r) => {
                    nexus_sampling_types::reasoning_item_text(r).len()
    ...
    pub(super) fn record_last_turn_usage(&mut self, usage: nexus_sampling_types::TokenUsage) {
    ...
    pub(super) fn record_model_call_usage(
        ...
        usage: &nexus_sampling_types::TokenUsage,
