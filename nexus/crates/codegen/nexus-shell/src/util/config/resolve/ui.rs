...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "NEXUS_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`NEXUS_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "NEXUS_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`NEXUS_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "NEXUS_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`NEXUS_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `NEXUS_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("NEXUS_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes NEXUS_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
