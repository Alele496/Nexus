...
use nexus_tools::implementations::nexus_build::task::types::{SubagentRequest, SubagentResult};
pub(crate) type GatewayOut = <acp::AgentSide as nexus_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(nexus_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-sage-test"),
        ...
        parent_skills: None,
        parent_skills_config: nexus_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: nexus_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: nexus_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl nexus_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &nexus_tools::implementations::lsp::LspToolInput,
    ) -> nexus_tools::implementations::lsp::LspToolResult {
        nexus_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<nexus_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<nexus_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
