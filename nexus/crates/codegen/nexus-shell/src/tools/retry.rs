//! Retry utilities — re-exported from `sage-tools`.
//!
//! The canonical implementation now lives in `nexus_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use nexus_tools::retry::BackoffConfig as RetryConfig;
pub use nexus_tools::retry::{BackoffConfig, execute_with_backoff};
