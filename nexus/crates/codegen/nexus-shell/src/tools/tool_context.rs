...
//! sage-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
use nexus_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use nexus_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn nexus_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<nexus_tools::implementations::nexus_build::task::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<nexus_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = nexus_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
