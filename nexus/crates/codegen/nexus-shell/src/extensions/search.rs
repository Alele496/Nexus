...
use nexus_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use nexus_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
