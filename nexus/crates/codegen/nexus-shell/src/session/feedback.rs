//! Feedback request heuristics for Sage sessions.
//!
...
impl FeedbackHeuristics {
    ...
    pub fn new() -> Self {
        Self {
            ...
            tier1_prompt:
                "You've been using Sage productively! Would you mind sharing quick feedback?"
                    .to_string(),
...
impl FeedbackRequest {
    ...
    pub fn with_mode(
        ...
        let prompt = match prompt_override {
            ...
            _ => match tier {
                FeedbackTier::Tier1 => {
                    "You've been using Sage productively! Would you mind sharing quick feedback?".to_string()
                }
                FeedbackTier::Tier2 => {
