...
fn usage_rows() -> Vec<(String, nexus_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        nexus_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use nexus_tools::implementations::nexus_build::task::types::SubagentOutstandingReply;
...
> {
    use nexus_tools::implementations::nexus_build::task::types::SubagentEvent;
