...
impl SessionActor {
        ...
        *self.current_prompt_mode.lock() = prompt_mode;
        ...
        if mode.is_plan() {
            ...
            nexus_telemetry::session_ctx::log_event(
                nexus_telemetry::events::PlanModeToggled {
                    enabled: true,
                    trigger: nexus_telemetry::events::PlanModeTrigger::User,
                    turn_in_flight,
    ...
    /// first-entry/reentry distinction), or sage's reentry/full variant.
