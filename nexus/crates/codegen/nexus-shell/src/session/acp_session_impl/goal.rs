...
impl RoleCapability {
    ...
    fn is_satisfied(
        self,
        summary: &nexus_tools::implementations::nexus_build::task::types::SubagentTypeSummary,
    ) -> bool {
        match self {
...
impl SessionActor {
    ...
    pub(super) async fn drain_goal_updates_with_extra(
        ...
        extra: Vec<nexus_tools::implementations::nexus_build::update_goal::UpdateGoalEnvelope>,
    ) {
    ...
    pub(crate) async fn resolve_goal_role_override(
        ...
        if nexus_agent::config::is_strict_harness_agent_type(&pair.agent_type)
    ...
    pub(super) async fn prune_prior_goal_continuation_directives(&self) {
        use nexus_sampling_types::conversation::SyntheticReason;
