...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<nexus_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(nexus_tools::implementations::nexus_build::update_goal::UpdateGoalInput),
    Channel(nexus_tools::implementations::nexus_build::update_goal::UpdateGoalEnvelope),
}
