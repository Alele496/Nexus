...
const K_IO_MESNEXUS_CAN_SYSTEM_SLEEP: u32 = 0xe000_0270;
const K_IO_MESNEXUS_SYSTEM_WILL_SLEEP: u32 = 0xe000_0280;
const K_IO_MESNEXUS_SYSTEM_WILL_NOT_SLEEP: u32 = 0xe000_0290;
const K_IO_MESNEXUS_SYSTEM_HAS_POWERED_ON: u32 = 0xe000_0300;
...
fn map_power_message(message_type: u32) -> (Option<PowerEvent>, bool) {
    match message_type {
        K_IO_MESNEXUS_CAN_SYSTEM_SLEEP => (Some(PowerEvent::WillSleep), true),
        K_IO_MESNEXUS_SYSTEM_WILL_SLEEP => (Some(PowerEvent::WillSleep), true),
        K_IO_MESNEXUS_SYSTEM_WILL_NOT_SLEEP => (Some(PowerEvent::DidWake), false),
        K_IO_MESNEXUS_SYSTEM_HAS_POWERED_ON => (Some(PowerEvent::DidWake), false),
        _ => (None, false),
    }
}
...
extern "C" fn power_callback(
    ...
    if let Some(event) = event {
        ...
        // `nexus_system_power` crate-level callback contract.
        (ctx.callback)(event);
    }
    if needs_ack {
...
mod tests {
    ...
    fn map_power_message_matrix() {
        assert_eq!(
            map_power_message(K_IO_MESNEXUS_CAN_SYSTEM_SLEEP),
            (Some(PowerEvent::WillSleep), true)
        );
        assert_eq!(
            map_power_message(K_IO_MESNEXUS_SYSTEM_WILL_SLEEP),
            (Some(PowerEvent::WillSleep), true)
        );
        assert_eq!(
            map_power_message(K_IO_MESNEXUS_SYSTEM_WILL_NOT_SLEEP),
            (Some(PowerEvent::DidWake), false)
        );
        assert_eq!(
            map_power_message(K_IO_MESNEXUS_SYSTEM_HAS_POWERED_ON),
            (Some(PowerEvent::DidWake), false)
        );
