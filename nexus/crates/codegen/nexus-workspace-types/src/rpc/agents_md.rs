...
/// Claude.md / `.nexus/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.nexus` and compat dirs.
...
/// Mirrors the serde shape of `sage-agent`'s `AgentConfigFile`.
