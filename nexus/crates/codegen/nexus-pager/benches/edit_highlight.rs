...
//!
//! ```text
//! cargo bench -p sage-pager --bench edit_highlight
//! cargo bench -p sage-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use nexus_pager::diff::{DiffHunk, DiffLine};
use nexus_pager::scrollback::blocks::tool::{
...
use nexus_pager::syntax::{Syntect, get_syntect};
