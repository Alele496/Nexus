...
# Env: SAGE_BIN_DIR, SAGE_PROXY_URL
#
# Usage:
...
#   $env:SAGE_VERSION="0.1.42"; irm https://x.ai/cli/enterprise-install.ps1 | iex           # specific version (alt)
#   $env:SAGE_DEPLOYMENT_KEY="<key>"; irm https://x.ai/cli/enterprise-install.ps1 | iex
#
