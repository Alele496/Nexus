...
use nexus_acp_lib::AcpResult;
use nexus_markdown::StreamingMarkdownRenderer;
pub use nexus_tools::implementations::nexus_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<nexus_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: nexus_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<nexus_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> nexus_tools::implementations::nexus_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: nexus_tools::implementations::nexus_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
