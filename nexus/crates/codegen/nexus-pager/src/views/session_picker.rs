...
impl SourceFilter {
    ...
    ///
    /// sage.local conversations carry `source == "conversation"` and live remotely,
...
pub(crate) fn capture_picker_selection(
    ...
    content_results: Option<&[nexus_shell::extensions::session_search::SearchSessionHit]>,
    state: &PickerState,
    query: &str,
    grouped: bool,
...
pub(crate) fn build_content_entry_data(
    hits: &[nexus_shell::extensions::session_search::SearchSessionHit],
    entries_data: &[SessionPickerEntry],
    filtered_indices: &[usize],
    state: &PickerState,
    content_start: usize,
...
mod tests {
    ...
    fn source_filter_matches() {
        ...
        // sage.local conversations are remote: visible under All + Remote, not Local.
