...
fn plugins_list_response() -> nexus_hooks_plugins_types::PluginsListResponse {
    use crate::views::extensions_modal::test_plugin_info;
    nexus_hooks_plugins_types::PluginsListResponse {
        plugins: vec![
            test_plugin_info(
                "user-tool",
                Some(nexus_hooks_plugins_types::PluginOrigin::UserSage),
            ),
            test_plugin_info(
                "claude-tool",
                Some(nexus_hooks_plugins_types::PluginOrigin::UserClaude),
            ),
        ],
    }
}
