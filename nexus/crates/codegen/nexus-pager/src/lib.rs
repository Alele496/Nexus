...
// minimal rendering lives in the sibling `sage-pager-minimal` crate; these
...
// `sage-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use nexus_pager_render::{
