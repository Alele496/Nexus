...
pub mod detection {
    pub use nexus_file_utils::workspace_classifier::is_project_dir;
}
pub mod sources;

use std::path::{Path, PathBuf};

use nexus_tools::implementations::nexus_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run Sage in a project directory?\n\n\
                 This gives Sage full context of your codebase for better results."
                .into(),
            id: None,
            options,
