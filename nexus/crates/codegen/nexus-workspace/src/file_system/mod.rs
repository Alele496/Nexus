...
// its wire types live in `nexus_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use nexus_workspace_types::rpc::fs::FsReadEncoding;
...
pub use nexus_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
