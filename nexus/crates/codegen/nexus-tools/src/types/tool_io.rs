...
use crate::implementations::nexus_build::ask_user_question::AskUserQuestionInput;
...
use crate::implementations::nexus_build::read_file::ReadFileInput;
use crate::implementations::nexus_build::search_replace::SearchReplaceInput;
use crate::implementations::nexus_build::todo::TodoWriteInput;
use crate::implementations::nexus_build::update_goal::UpdateGoalInput;
use crate::implementations::nexus_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::nexus_build::web_fetch::WebFetchInput;
use crate::implementations::nexus_build::web_search::WebSearchInput;
...
use nexus_tool_types::KillTaskToolInput;
use nexus_tool_types::TaskOutputToolInput;
use nexus_tool_types::TaskToolInput;
use nexus_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::nexus_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::nexus_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::nexus_build::scheduler::create::SchedulerCreateInput),
