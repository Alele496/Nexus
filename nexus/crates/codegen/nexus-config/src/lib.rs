...
//! 2. `$NEXUS_HOME/managed_config.toml`
//! 3. `$NEXUS_HOME/config.toml`
//! 4. `$NEXUS_HOME/requirements.toml` (cloud cache; Ed25519-signed at rest once a
//!    key is embedded — see [`signed_policy`] — below the OS-protected layers)
//! 5. `/etc/sage/requirements.toml`
//! 6. macOS MDM managed preferences (`ai.x.nexus`, admin-forced) — macOS only
//!
