//! sage-sampler - Actor-based sampling layer for xAI sage.
//!
//! This crate extracts the HTTP streaming + retry logic out of
//! `sage-shell`'s session actor into a standalone, reusable
//! component built on the same actor pattern as `sage-hunk-tracker`.
//!
//! ## Layered API
//!
