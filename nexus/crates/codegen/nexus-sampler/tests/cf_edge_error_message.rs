...
use nexus_sampler::{SamplerConfig, SamplingClient};
...
use nexus_test_support::{MockInferenceServer, ScriptedResponse};
...
async fn stream_err(status: u16, body: &str) -> nexus_sampling_types::SamplingError {
