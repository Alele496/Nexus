...
//! Sage to persist important information across sessions. Memory files are
//! stored under `~/.nexus/memory/` with workspace-scoped subdirectories
...
//! `NEXUS_MEMORY=1` environment variable. When disabled, this crate
