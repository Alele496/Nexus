//! # sage-hooks
//!
//! Runtime hook system for Sage — file-based discovery, command execution,
//! and policy enforcement.
//!
//! ## Overview
//!
//! This crate provides a minimal hooks system for Sage. Hooks are discovered
//! from dedicated directories (`~/.nexus/hooks/` and `<git-worktree-root>/.nexus/hooks/`),
...
//!     Some(Path::new("/home/user/.nexus/hooks")),
//!     Some(Path::new("/project/.nexus/hooks")),
//! );
//!
//! for err in &errors {
