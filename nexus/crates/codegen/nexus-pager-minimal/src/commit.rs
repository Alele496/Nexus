...
use nexus_pager::appearance::AppearanceConfig;
use nexus_pager::minimal_api;
use nexus_pager::render::Renderable;
use nexus_pager::scrollback::block::RenderBlock;
use nexus_pager::scrollback::blocks::ToolCallBlock;
use nexus_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            nexus_pager::scrollback::blocks::BtwBlock::new(
                "original question",
                "original answer",
            ),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use nexus_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                nexus_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
