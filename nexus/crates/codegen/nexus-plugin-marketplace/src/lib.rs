...
pub fn is_official_source_url(url: &str) -> bool {
    canonical_github_owner_repo(url).as_deref() == Some("sage-org/plugin-marketplace")
}
...
mod tests {
    ...
    fn is_official_matches_ssh_form() {
        ...
        assert!(is_official_source_url(
            "git@github.com:sage-org/plugin-marketplace"
        ));
        assert!(is_official_source_url(
            "ssh://git@github.com/sage-org/plugin-marketplace.git"
        ));
        assert!(is_official_source_url(
    ...
    fn is_official_matches_noncanonical_forms() {
        ...
        assert!(is_official_source_url(
            "http://github.com/sage-org/plugin-marketplace"
        ));
        assert!(is_official_source_url(
