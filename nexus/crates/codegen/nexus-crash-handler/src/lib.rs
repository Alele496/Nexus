...
//! }
//!
//! nexus_crash_handler::install(nexus_crash_handler::CrashHandlerConfig {
...
/// `$NEXUS_HOME` they must not be world-readable.
...
mod tests {
    ...
    fn check_previous_crash_returns_none_when_no_file() {
        let dir = PathBuf::from("/tmp/sage-crash-handler-test-nonexistent");
