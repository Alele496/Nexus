//! SageNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// SageNight palette — neutral gray base + TokyoNight accent colors.
//
