...
///        TUI but differ for embedding clients like sage-desktop.
...
/// OS-level sandbox state for a trace turn (local `sage-sandbox`, not cloud sandbox).
...
pub struct PromptMetadata {
    ...
    /// The agent type / harness name for this session (e.g. "sage-build", "codex").
    #[serde(default, skip_serializing_if = "Option::is_none")]
