...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `sage-tool-runtime`. Sampler-side wire
...
/// `nexus_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<nexus_tool_types::ToolDescription>,
}
