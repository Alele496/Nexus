...
use nexus_tool_protocol::{ToolCapabilities, ToolId};
...
/// `filename`, `path`, `metadata`) that the Sage SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Sage SLOP converter to
    ...
    /// - `path`: file path on the Sage Computer filesystem
