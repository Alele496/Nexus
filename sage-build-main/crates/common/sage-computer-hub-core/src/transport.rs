...
//!
//! [`TransportKind`] is re-exported from [`sage_tool_protocol`] so the wire
...
use sage_tool_protocol::{SessionId, ToolId, UserId};
use sage_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use sage_tool_protocol::TransportKind;
