...
fn map_block(block: sage_tool_protocol::McpBlock) -> ContentBlock {
    use sage_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: sage_tool_protocol::JsonRpcError) -> ToolError {
