...
//!
//! [`TransportKind`] is re-exported from [`nexus_tool_protocol`] so the wire
...
use nexus_tool_protocol::{SessionId, ToolId, UserId};
use nexus_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use nexus_tool_protocol::TransportKind;
