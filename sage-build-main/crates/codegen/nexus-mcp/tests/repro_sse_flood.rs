...
//!
//! Run with: cargo test -p sage-mcp --test repro_sse_flood -- --nocapture
...
use nexus_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use nexus_mcp::rmcp::ServiceExt;
use nexus_mcp::rmcp::transport::StreamableHttpClientTransport;
use nexus_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
