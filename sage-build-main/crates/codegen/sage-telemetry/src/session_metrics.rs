...
impl TraceUploadReason {
    ...
    pub fn from_upload_method(method: &Option<sage_file_utils::UploadMethod>) -> Self {
        match method {
            Some(sage_file_utils::UploadMethod::Proxy { .. }) => Self::Proxy,
            Some(sage_file_utils::UploadMethod::S3 { .. }) => Self::DirectS3,
            Some(sage_file_utils::UploadMethod::Direct { .. }) => Self::DirectGcs,
...
#[cfg(test)]
mod tests {
    use sage_file_utils::UploadMethod;
