...
impl CompactionScope {
    pub fn begin(
        ...
        let percentage = sage_token_estimation::usage_percentage_u8(tokens_used, context_window);
...
pub struct ToolCallCompleted {
    pub tool_name: String,
    pub outcome: sage_file_utils::events::types::ToolOutcome,
    pub duration_ms: u64,
...
telemetry_event!(SuperGrokUpsellShown, "supersage_upsell_shown");
telemetry_event!(SuperGrokUpsellClicked, "supersage_upsell_clicked");
