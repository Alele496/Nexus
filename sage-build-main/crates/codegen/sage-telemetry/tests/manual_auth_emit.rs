...
use sage_telemetry::client;
use sage_telemetry::config::{TelemetryConfig, TelemetryMode};
use sage_telemetry::events::{AuthTokenKind, ManualAuth, ManualAuthReason, ManualAuthSurface};

#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
async fn manual_auth_posts_to_events_endpoint_as_sage_shell_manual_auth() {
    ...
    sage_telemetry::log_event(ManualAuth {
