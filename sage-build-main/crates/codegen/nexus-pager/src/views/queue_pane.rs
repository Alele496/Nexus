...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. SageNight's dark band leaking into SageDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default SageNight, dark) after the user switches —
        // painting a dark band on a light SageDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use nexus_ratatui_textarea::ClipboardProvider;
