...
//! render mode.
//!
//! `sage-pager` cannot depend on `sage-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`sage-bin`) wires it up once at
//! startup by calling `nexus_pager_minimal::install()`. When nothing has
