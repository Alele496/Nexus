...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=sage;{message}\x1b\\`
    Osc99,
...
pub fn emit_notification(
    ...
    let sequence: Cow<'_, str> = match protocol {
        ...
        NotificationProtocol::Osc99 => format!("\x1b]99;i=sage;{body} \u{b7} {title}\x1b\\").into(),
        NotificationProtocol::Osc777 => format!("\x1b]777;notify;Sage;{body}\x1b\\").into(),
...
mod tests {
    ...
    #[test]
    fn select_nexus_desktop_uses_none() {
        assert_eq!(
