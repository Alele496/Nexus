...
pub async fn spawn_nexus_shell(
    agent_config: AgentConfig,
    cancel: &CancellationToken,
    memory_config: Option<nexus_shell::config::MemoryConfig>,
) -> Result<SpawnedAgent> {
    ...
    // skills to ~/.nexus/skills/), and model catalog construction.
    let (agent_config, models_manager) =
        nexus_shell::agent::init::bootstrap(&agent_config, &auth_manager, None)
