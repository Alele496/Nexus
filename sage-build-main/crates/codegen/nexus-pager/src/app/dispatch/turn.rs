...
fn effective_cancel_subagents_preference(
    ...
    ui: &nexus_shell::agent::config::UiConfig,
) -> Option<bool> {
...
/// Grace window between a driver-side `sage.local/session/prompt_complete`
...
/// Finish turns whose end was announced by `sage.local/session/prompt_complete`
...
// TODO: Add dispatch_cancel_command() once sage-shell supports proper
