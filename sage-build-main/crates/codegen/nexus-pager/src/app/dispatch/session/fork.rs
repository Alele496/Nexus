...
-> [nexus_tools::implementations::nexus_build::ask_user_question::QuestionOption; 2] {
    use nexus_tools::implementations::nexus_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `sage.local/session/fork` directly.
