...
fn critical_announcement(id: &str) -> nexus_announcements::RemoteAnnouncement {
...
fn promo_announcement(id: &str) -> nexus_announcements::RemoteAnnouncement {
    nexus_announcements::RemoteAnnouncement {
        id: Some(id.into()),
        message: Some(format!("{id} message")),
        severity: Some("promo".into()),
        cta: Some(nexus_announcements::AnnouncementCta {
            label: Some("Go".into()),
...
/// the promo url (observed via the `NEXUS_TEST_OPEN_URL_FILE` seam, from every
...
fn tick_propagates_available_commands_to_bootstrap() {
    ...
    let skill_meta = serde_json::json!(
        { "scope" : "user", "path" : "/home/user/.nexus/skills/pick-best/SKILL.md", }
    );
