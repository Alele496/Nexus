...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "sage-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "sage-3", "researcher");
    ...
    let shared_models = ["sage-3", "sage-3-mini"];
