# @xai-official/sage-linux-arm64

Platform-specific binary for [`@xai-official/sage`](https://www.npmjs.com/package/@xai-official/sage) on linux-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @xai-official/sage
```
