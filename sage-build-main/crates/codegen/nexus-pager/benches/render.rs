//! Criterion benchmarks for the sage-pager rendering pipeline.
//!
...
use nexus_pager::scrollback::render::render_scrolled_entries_with_scratch;
use nexus_pager::scrollback::wrappers::EntryRenderer;
use nexus_pager::scrollback::{
