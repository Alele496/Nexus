...
Terminal UI (TUI) for Sage. Provides the interactive full-screen interface
...
- [Hook Examples](../sage-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`sage-hooks`)](../sage-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`sage-plugin-marketplace`)](../sage-plugin-marketplace/) — marketplace source loading, scanning, and install
