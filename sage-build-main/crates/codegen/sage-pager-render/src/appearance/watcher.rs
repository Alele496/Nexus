...
//!
//! In dev mode, watches ~/.sage/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.sage/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.sage/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = sage_config::user_sage_home()
