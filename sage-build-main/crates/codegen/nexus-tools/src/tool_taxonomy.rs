...
mod tests {
    ...
    fn identity(kind: ToolKind) -> ToolIdentity {
        ToolIdentity {
            tool_kind: kind,
            namespace: ToolNamespace::SageBuild,
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::SageBuild => ("nexus_build", "NexusBuild"),
                ToolNamespace::SageBuildConcise => ("nexus_build_concise", "NexusBuildConcise"),
                ToolNamespace::SageBuildHashline => ("nexus_build_hashline", "NexusBuildHashline"),
