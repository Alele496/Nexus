...
crate::register_resource!("nexus_build", "ListDir", ListDirParams);
...
impl nexus_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(nexus_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
