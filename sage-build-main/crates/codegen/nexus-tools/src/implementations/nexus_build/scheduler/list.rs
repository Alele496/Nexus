...
impl nexus_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl nexus_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> nexus_tool_protocol::ToolId {
        nexus_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, nexus_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                nexus_tool_runtime::ToolError::execution(
                    nexus_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
