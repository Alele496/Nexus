...
impl nexus_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> nexus_tool_protocol::ToolId {
        nexus_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                nexus_tool_runtime::ToolError::execution(
                    nexus_tool_protocol::ToolId::new("memory_search").expect("valid"),
