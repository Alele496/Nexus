//! AcpFsAdapter: implements `sage-tools::AsyncFileSystem` using ACP gateway calls.
//!
//! This adapter enables file tool execution over ACP (remote filesystem).
//! It translates sage-tools' `AsyncFileSystem` trait into ACP protocol calls:
...
use nexus_tools::computer::types::{AsyncFileSystem, ComputerError};

/// Wraps sage-shell's ACP gateway to satisfy sage-tools' AsyncFileSystem.
///
