...
/// [`AuthIdentity`](nexus_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<nexus_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: nexus_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Version of the `sage-workspace` crate that produced the record.
    ...
    /// Sandbox profile name (`$NEXUS_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("NEXUS_SANDBOX_PROFILE").ok(),
            nexus_sandbox::is_inside_bwrap(),
