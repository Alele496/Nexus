...
//!
//! `sage_hooks` pulls in `git2`/`reqwest`/`sage-tools`, too heavy for
...
/// Wire mirror of `sage_hooks::discovery::HookRegistry`.
///
...
/// Wire mirror of `sage_hooks::config::HookSpec`.
///
...
/// Wire mirror of `sage_hooks::event::HookEventName`.
///
