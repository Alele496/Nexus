...
//!
//! In dev mode, watches ~/.nexus/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.nexus/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.nexus/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = nexus_config::user_nexus_home()
