...
//! Dark themes (SageNight, TokyoNight) share `sage-night.tmTheme`;
//! SageDay uses `sage-day.tmTheme` with deepened colors for light backgrounds.

use std::sync::OnceLock;

pub use nexus_markdown::Syntect;
...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_GROKNIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/sage-night.tmTheme"))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new(include_bytes!("../assets/tokyo-night.tmTheme"))),
        ThemeKind::SageDay => SYNTECT_GROKDAY
            .get_or_init(|| Syntect::new(include_bytes!("../assets/sage-day.tmTheme"))),
    }
}
