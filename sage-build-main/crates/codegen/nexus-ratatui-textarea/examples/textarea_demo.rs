...
//!
//! Run with: cargo run -p sage-ratatui-textarea --example textarea_demo
//!
...
use nexus_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use nexus_ratatui_textarea::{
