...
/// The base prompt template source, exposed for `sage prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `sage prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard sage-build tool kinds.
