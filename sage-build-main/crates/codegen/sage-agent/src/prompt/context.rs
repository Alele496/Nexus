...
pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = "Sage";
...
mod tests {
    ...
    fn test_placeholders_system_prompt_label_override() {
        let mut ctx = test_context();
        ctx.system_prompt_label = "Sage Internal".into();
        let p = ctx.placeholders();
        assert_eq!(p["system_prompt_label"], "Sage Internal");
    }
    #[test]
    ...
    fn test_agents_md_paths_use_display_cwd_in_rendered_section() {
        ...
        let overlay_path = "/root/.sage/worktrees/my-project/ab-123-a-overlay";
