...
use sage_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (sage_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    sage_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use sage_shell::tools::{TodoItem, TodoPriority};
