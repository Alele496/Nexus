...
use sage_pager::appearance::AppearanceConfig;
use sage_pager::minimal_api;
use sage_pager::render::Renderable;
use sage_pager::scrollback::block::RenderBlock;
use sage_pager::scrollback::blocks::ToolCallBlock;
use sage_pager::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn btw_block_emits_once_across_repeated_frontier_passes() {
        ...
        s.push(ScrollbackEntry::new(RenderBlock::Btw(
            sage_pager::scrollback::blocks::BtwBlock::new(
                "original question",
                "original answer",
            ),
        )));
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use ratatui::buffer::Buffer;
        use sage_pager::theme::cache as theme_cache;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                sage_pager::theme::cache::set_terminal_native_lock(false);
            }
        }
