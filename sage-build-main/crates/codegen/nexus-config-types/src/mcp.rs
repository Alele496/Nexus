//! MCP server configuration value types, extracted from sage-shell
...
use nexus_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("NEXUS_RELAY_SYNC_ENABLED") {
