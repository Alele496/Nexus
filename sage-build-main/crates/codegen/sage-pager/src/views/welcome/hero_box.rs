...
const HERO_SUBTITLE: &str = "Thanks for trying Sage, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&sage_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Sage 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Sage 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(sage_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://sage.local".into()),
        ...
        let mut dismissible = ann(None, Some("Sage 4.5 is here. Upgrade now."));
        dismissible.cta = Some(sage_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://sage.local".into()),
            caption: Some("or use Ctrl+O".into()),
        });
