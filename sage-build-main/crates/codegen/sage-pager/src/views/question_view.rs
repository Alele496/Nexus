...
use sage_acp_lib::AcpResult;
use sage_markdown::StreamingMarkdownRenderer;
pub use sage_tools::implementations::sage_build::ask_user_question::{
...
pub enum LocalQuestionKind {
    ...
    CreditLimitUpsell {
        choices: Vec<sage_telemetry::events::CreditLimitChoice>,
    },
    ...
    FreeUsageUpsell {
        ...
        source: sage_telemetry::events::SuperGrokUpsell,
    },
    ...
    AgentTypeMismatch {
        ...
        effort: Option<sage_shell::sampling::types::ReasoningEffort>,
    },
}
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> sage_tools::implementations::sage_build::ask_user_question::AskUserQuestionExtResponse
    {
    ...
    pub fn send_ext_response(
        &mut self,
        response: sage_tools::implementations::sage_build::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
