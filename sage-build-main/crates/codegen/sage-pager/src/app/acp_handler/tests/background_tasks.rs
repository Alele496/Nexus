#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// notifications through the generic `sage.local/session/update` envelope. A
    ...
    fn ext_session_update_replay_restores_bg_task() {
        ...
        handle(
            make_ext_session_notification_with_method("sess-1", "sage.local/session/update", update),
            &mut app,
        );
