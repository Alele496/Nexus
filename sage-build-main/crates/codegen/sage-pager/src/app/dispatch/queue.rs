...
///
/// Delegates to the shared implementation in `sage_tools::reminders`.
...
fn format_cron_prompt(prompt: &str, task_id: &str, human_schedule: &str) -> String {
    sage_tools::reminders::format_scheduled_task_prompt(prompt, task_id, human_schedule)
}
...
mod tests {
    ...
    fn drain_scroll_honors_page_flip_setting() {
        ...
        crate::appearance::cache::set_page_flip_on_send(
            sage_shell::agent::config::UiConfig::PAGE_FLIP_ON_SEND_DEFAULT,
        );
    }
