                ...
                if let Err(msg) = self.prompt.insert_image(pasted) {
                    ...
                    if ctx.source.tip_showing() {
                        sage_telemetry::session_ctx::log_event(
                            sage_telemetry::events::ContextualTip {
...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question =
            sage_tools::implementations::sage_build::ask_user_question::Question {
                question: "Pick one?".to_string(),
                options: vec![
                sage_tools::implementations::sage_build::ask_user_question::QuestionOption
