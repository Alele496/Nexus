...
fn shorten_path(path: &str) -> &str {
    let memory_root = sage_config::sage_home().join("memory");
...
**File:** /root/.sage/memory/MEMORY.md (lines 0-10)
```
## Project Conventions
...
"#;
        ...
        assert_eq!(results[0].path, "/root/.sage/memory/MEMORY.md");
...
**File:** /root/.sage/memory/ws/MEMORY.md (lines 1-5)
```
workspace content
```

### Result 2 (score: 0.42, source: session)
**File:** /root/.sage/memory/ws/sessions/2026-05-01.md (lines 10-20)
```
session content
```
"#;
