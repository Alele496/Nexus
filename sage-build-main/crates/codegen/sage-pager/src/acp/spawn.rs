...
pub async fn spawn_sage_shell(
    agent_config: AgentConfig,
    cancel: &CancellationToken,
    memory_config: Option<sage_shell::config::MemoryConfig>,
) -> Result<SpawnedAgent> {
    ...
    // skills to ~/.sage/skills/), and model catalog construction.
    let (agent_config, models_manager) =
        sage_shell::agent::init::bootstrap(&agent_config, &auth_manager, None)
