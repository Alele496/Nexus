...
//
// Concrete codes must match `sage_voice::STT_LANGUAGES` (official Sage STT
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        // The `SAGE_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        // Catalog = official STT languages (see sage_voice::STT_LANGUAGES).
        SettingMeta {
