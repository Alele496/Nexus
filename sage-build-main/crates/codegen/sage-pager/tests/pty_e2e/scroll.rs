...
use sage_pager_pty_harness::PtyHarness;
pub(crate) use sage_pager_pty_harness::{SGR_SCROLL_DOWN, SGR_SCROLL_UP};
...
/// (e.g. `SAGE_SCROLL_SPEED`) appended to the controller's env.
