...
pub struct GrokAuth {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub has_sage_code_access: Option<bool>,
...
/// Early-invalidation buffer. Override with `SAGE_AUTH_EARLY_INVALIDATION_SECS`
/// for testing (e.g. `=5` to shrink the buffer to 5 seconds).
pub(super) fn early_invalidation() -> Duration {
    std::env::var("SAGE_AUTH_EARLY_INVALIDATION_SECS")
        .ok()
