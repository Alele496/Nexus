...
pub(crate) const ENV_REMEMBER_TOOL_APPROVALS: &str = "SAGE_REMEMBER_TOOL_APPROVALS";
...
/// shown. Precedence: requirements > env (`SAGE_REMEMBER_TOOL_APPROVALS`) >
...
mod remember_tool_approvals_gate_tests {
    ...
    // `SAGE_REMEMBER_TOOL_APPROVALS` is process-global; serialize and force it
