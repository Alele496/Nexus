...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "SAGE_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "SAGE_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`SAGE_MIN_DRAW_MS` / `SAGE_SCROLL_CADENCE_MS`).
