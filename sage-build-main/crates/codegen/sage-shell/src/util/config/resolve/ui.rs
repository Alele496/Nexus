...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "SAGE_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`SAGE_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "SAGE_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`SAGE_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "SAGE_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`SAGE_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `SAGE_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("SAGE_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes SAGE_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
