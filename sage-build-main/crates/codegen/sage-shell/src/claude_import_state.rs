...
//
// State is persisted to `~/.sage/claude_import_state.json`.
...
use sage_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.sage/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::sage_home::sage_home().join("claude_import_state.json")
}
