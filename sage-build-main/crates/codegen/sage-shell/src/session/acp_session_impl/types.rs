...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<sage_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(sage_tools::implementations::sage_build::update_goal::UpdateGoalInput),
    Channel(sage_tools::implementations::sage_build::update_goal::UpdateGoalEnvelope),
}
