...
impl SessionActor {
    ...
    /// sees "Sage is thinking", streaming token chunks, or any other
    ...
    pub(crate) async fn maybe_fire_laziness_check(self: Arc<Self>) {
        ...
        let request = ConversationRequest {
            ...
            x_sage_conv_id: Some(session_id_str.clone()),
            x_sage_req_id: Some(format!("{LAZINESS_REQ_ID_PREFIX}{}", uuid::Uuid::new_v4())),
            x_sage_session_id: Some(session_id_str),
