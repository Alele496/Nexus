...
pub(crate) use sage_interjection_core::{InterjectionBuffer, drain_formatted, format_interjection};

/// Shell instantiation of the shared entry type: images are ACP content.
pub(crate) type PendingInterjection = sage_interjection_core::PendingInterjection<acp::ImageContent>;
