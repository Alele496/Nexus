...
//! shell-specific types (`sage_tools::MemoryBackend`, memory context).
//!
//! The core [`CompactionStateContext`] struct and its builder live in
//! `sage_chat_state::compaction_utils`. This module adds system-reminder
...
//! [`sage_compaction::reminder`] so sage-chat and sage-build stay in lockstep.
...
pub fn to_system_reminder_sync(
    ...
    skills: &[sage_tools::implementations::skills::types::SkillInfo],
...
pub async fn to_system_reminder(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[sage_tools::implementations::skills::types::SkillInfo],
    memory_backend: Option<&dyn sage_tools::types::memory_backend::MemoryBackend>,
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
...
fn to_system_reminder_inner(
    ...
    discovered_agents_md: &[PathBuf],
    skills: &[sage_tools::implementations::skills::types::SkillInfo],
    memory_results: &[sage_tools::types::memory_backend::MemorySearchResult],
    subagent_tool_names: Option<&SubagentToolNames>,
    mcp_tool_names: Option<&McpToolNames>,
) -> Option<String> {
    ...
    if let Some(listing) =
        sage_tools::types::skill_discovery_tracker::format_compaction_skill_listing(skills)
    {
    ...
    if !ctx.connected_mcp_servers.is_empty() {
        use sage_tools::implementations::search_tool::format_compaction_server_line;
