...
//! window containing a [`sage_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`sage_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`sage_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`sage_mcp::servers::ClientStateKind::Empty`]
...
use sage_mcp::servers::{McpClientEventKind, McpServerName};
