...
fn usage_rows() -> Vec<(String, sage_chat_state::UsageTotals)> {
    vec![(
        "m".into(),
        sage_chat_state::UsageTotals {
            input_tokens: 40,
            model_calls: 1,
            ..Default::default()
        },
...
fn usage_drain_outcome_policy_matches_freeze_and_cancel() {
    ...
    use sage_tools::implementations::sage_build::task::types::SubagentOutstandingReply;
...
> {
    use sage_tools::implementations::sage_build::task::types::SubagentEvent;
