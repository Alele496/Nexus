...
//!
//! Canonical definitions live in `sage_prompt_queue`; this re-export keeps every existing
//! `crate::session::prompt_queue::*` and cross-crate `sage_shell::session::prompt_queue::*`
//! path resolving without edits.

pub use sage_prompt_queue::{QueueChanged, QueueEntryMeta, QueueEntryWire};
