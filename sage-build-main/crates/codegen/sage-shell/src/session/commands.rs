...
pub enum SessionCommand {
    ...
    SetSessionModel {
        sampling_config: sage_sampler::SamplerConfig,
        use_concise: bool,
    ...
    GetModelMetadata {
        responds_to: oneshot::Sender<sage_chat_state::ModelMetadata>,
    },
    ...
    ReloadPlugins {
        registry: Option<std::sync::Arc<sage_agent::plugins::PluginRegistry>>,
    },
    /// Re-discover the session's own project hooks (`.sage/hooks`,
    ...
    RepairHistory {
        dry_run: bool,
        respond_to:
            oneshot::Sender<anyhow::Result<sage_chat_state::compaction_utils::HistoryRepairReport>>,
    },
    GetRewindPoints {
    ...
    RecordSubagentUsage {
        by_model: Vec<(String, sage_chat_state::UsageTotals)>,
    ...
    SnapshotToolDefinitions {
        respond_to: oneshot::Sender<Vec<sage_sampling_types::ToolSpec>>,
    },
    ...
    KillBackgroundTask {
        task_id: String,
        respond_to: oneshot::Sender<Result<sage_tools::types::KillOutcome, String>>,
    },
    DeleteScheduledTask {
        task_id: String,
    ...
    ListTasks {
        respond_to: oneshot::Sender<Option<Vec<sage_tools::types::TaskSnapshot>>>,
    },
    ...
    GetHooksList {
        respond_to: oneshot::Sender<sage_hooks_plugins_types::HooksListResponse>,
    },
    /// Execute a hooks management action from the pager modal.
    HooksAction {
        action: sage_hooks_plugins_types::HooksAction,
        respond_to: oneshot::Sender<sage_hooks_plugins_types::ActionOutcome>,
    },
    ...
    PluginsList {
        respond_to:
            oneshot::Sender<Option<std::sync::Arc<sage_agent::plugins::PluginRegistry>>>,
    },
    ...
    TakeTurnMessages {
        respond_to: oneshot::Sender<Option<sage_chat_state::TurnCapture>>,
    },
    ...
    TakeHarnessTraceTurns {
        respond_to:
            oneshot::Sender<Vec<Vec<sage_sampling_types::conversation::ConversationItem>>>,
    },
