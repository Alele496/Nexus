...
use sage_workspace::file_system::{
...
mod tests {
    ...
    #[test]
    fn test_sage_render_plain_message() {
        let result = render_grok("hello", vec![], vec![], &[], false);
        assert_eq!(result, "<user_query>\nhello\n</user_query>");
    }
    #[test]
    fn test_sage_render_with_attachments_uses_system_reminder_wrapper() {
        ...
        assert!(
            ...
            "Sage should start with <user_query>, got: {result}"
        );
    }
    #[test]
    fn test_sage_render_user_query_first() {
        ...
        assert!(
            uq_pos < rr_pos,
            "Sage: <user_query> ({uq_pos}) should come before resource links ({rr_pos})\ngot: {result}"
        );
        assert!(result.contains("<system-reminder>"));
    }
    #[test]
    fn test_sage_render_resource_links_use_focused_files_format() {
        let links = vec![
