...
use sage_workspace::file_system::{AsyncFileSystem, AsyncFsWrapper};
use sage_workspace::session::file_state::FileStateHandle;
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn sage_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<sage_tools::implementations::sage_build::task::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<sage_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    pub fn new(
        ...
        let session_env = sage_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
