...
//!
//! The canonical implementation now lives in `sage_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use sage_tools::retry::BackoffConfig as RetryConfig;
pub use sage_tools::retry::{BackoffConfig, execute_with_backoff};
