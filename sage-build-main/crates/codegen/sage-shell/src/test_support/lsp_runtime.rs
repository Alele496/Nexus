...
use sage_tools::implementations::sage_build::task::types::{SubagentRequest, SubagentResult};
pub(crate) type GatewayOut = <acp::AgentSide as sage_acp_lib::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        fs: Arc::new(sage_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        parent_skills: None,
        parent_skills_config: sage_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: sage_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: sage_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl sage_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &sage_tools::implementations::lsp::LspToolInput,
    ) -> sage_tools::implementations::lsp::LspToolResult {
        sage_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<sage_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<sage_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
