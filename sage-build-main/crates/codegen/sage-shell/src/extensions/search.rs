...
use sage_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use sage_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
