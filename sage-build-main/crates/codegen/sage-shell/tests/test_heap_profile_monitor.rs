...
use sage_shell::auth::{AuthManager, AuthMode, GrokAuth, SageComConfig};
use sage_shell::heap_profile::{
...
use sage_test_support::{EnvGuard, MockInferenceServer};
use sage_version::TEST_VERSION_ENV;
...
fn assert_storage_auth(uploads: &[sage_test_support::mock_server::StorageUpload]) {
    for u in uploads {
        assert_eq!(
