...
//
// State is persisted to `~/.nexus/claude_import_state.json`.
...
use nexus_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.nexus/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::nexus_home::nexus_home().join("claude_import_state.json")
}
