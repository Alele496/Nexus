...
///
/// [`SubagentRuntimeOverrides::harness_agent_type`]: nexus_tools::implementations::nexus_build::task::types::SubagentRuntimeOverrides::harness_agent_type
...
mod tests {
    ...
    async fn fail_open_retry_emits_spawn_failed_event() {
        ...
        let writer = nexus_file_utils::events::EventWriter::open(dir.path());
        let ov = RoleSpawnOverride {
            model: Some("m".into()),
            agent_type: Some("t".into()),
        };
