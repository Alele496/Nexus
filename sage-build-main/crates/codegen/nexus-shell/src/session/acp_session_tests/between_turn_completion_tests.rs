use nexus_tools::implementations::nexus_build::task::types::SubagentCompletionSummary;
use nexus_tools::reminders::task_completion::format_between_turn_completions;
