...
//! window containing a [`nexus_mcp::servers::McpClientEventKind::TransportClosed`]
//! or [`nexus_mcp::servers::McpClientEventKind::HandshakeFailed`] key for a
...
//!    [`nexus_mcp::servers::start_mcp_server`] sets
...
//!    push and stop.
//! 5. **Already-Empty** — see the [`nexus_mcp::servers::ClientStateKind::Empty`]
...
use nexus_mcp::servers::{McpClientEventKind, McpServerName};
