...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "NEXUS_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "NEXUS_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`NEXUS_MIN_DRAW_MS` / `NEXUS_SCROLL_CADENCE_MS`).
