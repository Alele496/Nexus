...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* nexus_home (where this hydrated copy lives),
            ...
            sandbox_profile: nexus_sandbox::configured_profile_name().map(String::from),
    ...
    const REPLAYABLE_METHODS: &[&str] = &["session/update", "_sage.local/session/update"];
