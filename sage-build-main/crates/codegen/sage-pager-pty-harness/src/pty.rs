...
const CLIPBOARD_SINK_ENV_VARS: &[&str] = &["SAGE_OSC52_SINK", "LC_SAGE_OSC52_SINK"];
...
mod tests {
    ...
    fn apply_child_env_strips_all_host_terminal_markers() {
        ...
        cmd.env("SAGE_SCROLL_LOG", "/tmp/scroll.jsonl");
        ...
        assert_eq!(
            cmd.get_env("SAGE_SCROLL_LOG").and_then(|v| v.to_str()),
    ...
    fn apply_child_env_caller_env_overrides_survive_strips() {
        ...
        assert_eq!(
            cmd.get_env("SAGE_OSC52_SINK").and_then(|v| v.to_str()),
            Some("1"),
