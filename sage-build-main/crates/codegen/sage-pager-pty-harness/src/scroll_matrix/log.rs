//! `SAGE_SCROLL_LOG` JSONL parsing, per-stream grouping, and finalize
//! synchronization.
//!
...
/// Parse a `SAGE_SCROLL_LOG` JSONL file into records.
///
...
/// session (`SAGE_SCROLL_LOG` set at spawn): `stream_start` → `flush`* →
