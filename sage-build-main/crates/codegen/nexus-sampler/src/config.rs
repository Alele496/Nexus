...
//! `nexus_sampling_types::SamplingConfig` so that the sampler crate
...
/// composing chat-state's `nexus_sampling_types::SamplingConfig`
...
pub struct SamplerConfig {
    ...
    /// client itself sends the opt-in `x-sage-doom-loop-check` header on
