...
mod tests {
    ...
    fn namespace_round_trips_snake_case_with_pascal_aliases() {
        ...
        fn wire_and_pascal(ns: ToolNamespace) -> (&'static str, &'static str) {
            match ns {
                ToolNamespace::SageBuild => ("sage_build", "SageBuild"),
                ToolNamespace::SageBuildConcise => ("sage_build_concise", "SageBuildConcise"),
                ToolNamespace::SageBuildHashline => ("sage_build_hashline", "SageBuildHashline"),
