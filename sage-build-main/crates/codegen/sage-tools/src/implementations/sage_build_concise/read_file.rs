...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::SageBuildConcise
    }
...
impl sage_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // SageBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::sage_build::read_file::ReadFileTool;
