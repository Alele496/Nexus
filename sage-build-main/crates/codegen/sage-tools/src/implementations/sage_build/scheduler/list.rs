...
impl sage_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl sage_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> sage_tool_protocol::ToolId {
        sage_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, sage_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                sage_tool_runtime::ToolError::execution(
                    sage_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
