...
crate::register_resource!("sage_build", "ListDir", ListDirParams);
...
impl sage_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(sage_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
