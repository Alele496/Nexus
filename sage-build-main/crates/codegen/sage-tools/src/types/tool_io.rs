...
use crate::implementations::sage_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::sage_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::sage_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::sage_build::grep::GrepSearchInput;
use crate::implementations::sage_build::image_edit::ImageEditInput;
use crate::implementations::sage_build::image_gen::ImageGenInput;
use crate::implementations::sage_build::list_dir::ListDirInput;
use crate::implementations::sage_build::read_file::ReadFileInput;
use crate::implementations::sage_build::search_replace::SearchReplaceInput;
use crate::implementations::sage_build::todo::TodoWriteInput;
use crate::implementations::sage_build::update_goal::UpdateGoalInput;
use crate::implementations::sage_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::sage_build::web_fetch::WebFetchInput;
use crate::implementations::sage_build::web_search::WebSearchInput;
...
use sage_tool_types::KillTaskToolInput;
use sage_tool_types::TaskOutputToolInput;
use sage_tool_types::TaskToolInput;
use sage_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::sage_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::sage_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::sage_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::sage_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::sage_build::scheduler::list::SchedulerListInput),
