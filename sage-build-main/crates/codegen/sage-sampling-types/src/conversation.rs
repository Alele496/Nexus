...
pub struct ConversationRequest {
    ...
    pub x_sage_conv_id: Option<String>,
    pub x_sage_req_id: Option<String>,
    pub x_sage_session_id: Option<String>,
    pub x_sage_turn_idx: Option<String>,
    pub x_sage_agent_id: Option<String>,
    pub x_sage_deployment_id: Option<String>,
    pub x_sage_user_id: Option<String>,
...
impl sage_compaction::CompactionItem for ConversationItem {
    fn role(&self) -> sage_compaction::CompactionRole {
        use sage_compaction::CompactionRole;
    ...
    fn attachment_refs(&self) -> Vec<sage_compaction::CompactionFileRef> {
        ...
        // image attachments need to survive into the `<sage_user_queries>`
        // preamble.
        Vec::new()
    }
}

impl sage_compaction::CompactionItemFactory for ConversationItem {
...
impl From<ConversationRequest> for ChatCompletionRequest {
    fn from(req: ConversationRequest) -> Self {
        ...
        // Enable DeepSeek thinking mode when reasoning_effort is set.
        let thinking = req.reasoning_effort.map(|_| ThinkingConfig::enabled());
        ChatCompletionRequest {
            ...
            thinking,
            x_sage_conv_id: req.x_sage_conv_id,
            x_sage_req_id: req.x_sage_req_id,
            x_sage_session_id: req.x_sage_session_id,
            x_sage_turn_idx: req.x_sage_turn_idx,
            x_sage_agent_id: req.x_sage_agent_id,
            x_sage_deployment_id: req.x_sage_deployment_id,
            x_sage_user_id: req.x_sage_user_id,
            trace: None,
        }
    }
}
...
impl ConversationRequest {
    ...
    pub fn with_conv_id(mut self, conv_id: impl Into<String>) -> Self {
        self.x_sage_conv_id = Some(conv_id.into());
        self
    }

    /// Set request ID header
    pub fn with_req_id(mut self, req_id: impl Into<String>) -> Self {
        self.x_sage_req_id = Some(req_id.into());
        self
    }
...
mod compaction_item_bridge_tests {
    use super::*;
    use sage_compaction::{CompactionItem, CompactionItemFactory, CompactionRole};
...
mod tests {
    ...
    fn test_transform_cwd_transforms_tool_call_arguments() {
        ...
        let worktree = "/home/user/.sage/worktrees/project/ab-uuid-a";
    ...
    fn test_transform_cwd_worktree_to_root_syncback() {
        ...
        let worktree = "/home/user/.sage/worktrees/myproject/fork-a";
    ...
    fn test_transform_cwd_assistant_only_tool_calls_no_content() {
        ...
        let worktree = "/home/user/.sage/worktrees/proj/fork-a";
    ...
    fn test_conversation_request_builder() {
        ...
        assert_eq!(req.x_sage_conv_id, Some("conv-123".to_string()));
        assert_eq!(req.x_sage_req_id, Some("req-456".to_string()));
    ...
    #[test]
    fn upgrade_legacy_reasoning_singular_sage_build_shape() {
