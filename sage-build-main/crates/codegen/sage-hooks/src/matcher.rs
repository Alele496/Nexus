use regex::Regex;
use sage_tools::types::{claude_names_for, sage_names_for};
...
fn exact_names(pattern: &str) -> Vec<String> {
    ...
    for term in pattern.split('|') {
        push(term);
        for sage_name in sage_names_for(term) {
            push(sage_name);
        }
    }
    names
...
mod tests {
    ...
    #[test]
    fn claude_bash_matches_sage_tool() {
    ...
    #[test]
    fn claude_edit_write_matches_sage_tool_exactly() {
    ...
    #[test]
    fn claude_read_matches_sage_tool() {
    ...
    #[test]
    fn regex_against_claude_alias_matches_sage_tool() {
