...
pub(crate) fn git_command() -> Command {
    ...
    cmd.envs(nexus_tty_utils::pager_env());
...
mod tests {
    ...
    fn test_rehydrate_registers_worktree_in_db() {
        ...
        // Isolate the worktree DB (lock + NEXUS_HOME → private tmp + restore).
        ...
        // global NEXUS_HOME) DB and INSERT-OR-REPLACE our row.
        ...
        // other subagent rows since NEXUS_HOME is process-global.
