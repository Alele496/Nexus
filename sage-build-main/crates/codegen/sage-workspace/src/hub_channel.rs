...
pub use sage_workspace_client::consume_stream_terminal;

/// Extract a `WorkspaceEvent` from a custom `ToolNotificationFrame`.
pub fn extract_workspace_event(
    frame: &sage_tool_protocol::ToolNotificationFrame,
) -> Option<WorkspaceEvent> {
    use sage_tool_protocol::WireToolNotification;
...
mod tests {
    use super::*;
    use sage_tool_protocol::{ToolId, ToolNotificationFrame, WireToolNotification};
