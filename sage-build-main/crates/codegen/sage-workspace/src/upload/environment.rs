...
/// [`AuthIdentity`](sage_computer_hub_sdk::AuthIdentity). The two types carry the
...
impl From<sage_computer_hub_sdk::AuthIdentity> for WorkspaceIdentity {
    fn from(id: sage_computer_hub_sdk::AuthIdentity) -> Self {
...
pub struct WorkspaceEnvironment {
    ...
    /// Sandbox profile name (`$SAGE_SANDBOX_PROFILE`), e.g. `"devbox"`.
...
impl WorkspaceEnvironment {
    ...
    pub(crate) fn capture(
        ...
        Self::assemble(
            ...
            server_id,
            sandbox_id,
            std::env::var("SAGE_SANDBOX_PROFILE").ok(),
            sage_sandbox::is_inside_bwrap(),
