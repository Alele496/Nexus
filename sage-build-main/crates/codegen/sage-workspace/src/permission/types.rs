...
pub enum ClientType {
    ...
    /// `"sage_pager"` form for symmetry with the rest of this enum.
    #[serde(rename = "sage-pager", alias = "sage_pager")]
    GrokPager,
...
impl From<&sage_tools::types::ToolInput> for AccessKind {
    fn from(input: &sage_tools::types::ToolInput) -> Self {
...
pub enum RequirementSource {
    Unknown,
    /// User-writable `~/.sage/requirements.toml` — untrusted for keeping a
...
mod tests {
    ...
    fn hashline_edit_maps_to_edit_access() {
        use sage_tools::implementations::sage_build_hashline::edit::types::HashlineEditInput;
        use sage_tools::types::ToolInput;
    ...
    fn bash_maps_to_bash_access() {
        use sage_tools::implementations::sage_build::bash::BashToolInput;
        use sage_tools::types::ToolInput;
    ...
    fn use_tool_maps_to_mcp_tool_access() {
        use sage_tools::implementations::use_tool::UseToolInput;
        use sage_tools::types::ToolInput;
    ...
    fn monitor_maps_to_bash_access() {
        use sage_tools::implementations::sage_build::monitor::types::MonitorInput;
        use sage_tools::types::ToolInput;
    ...
    fn web_fetch_maps_to_web_fetch_access() {
        use sage_tools::implementations::sage_build::web_fetch::WebFetchInput;
        use sage_tools::types::ToolInput;
    ...
    fn web_search_maps_to_web_search_access() {
        use sage_tools::implementations::sage_build::web_search::WebSearchInput;
        use sage_tools::types::ToolInput;
    ...
    #[test]
    fn client_type_deserializes_sage_shell_as_generic() {
        assert_eq!(
            serde_json::from_value::<ClientType>("sage-shell".into()).unwrap(),
            ClientType::Generic,
        );
        assert_eq!(
            serde_json::from_value::<ClientType>("sage_shell".into()).unwrap(),
            ClientType::Generic,
        );
        assert_eq!(
