...
/// `~/.sage/sessions/{cwd}/{session_id}/pasted/` so the model can `read_file`
...
mod tests {
    ...
    #[tokio::test]
    async fn test_sage_render_embedded_resource_uses_file_contents_tag() {
    ...
    #[tokio::test]
    async fn test_sage_render_embedded_resource_full_file_uses_is_full_file() {
