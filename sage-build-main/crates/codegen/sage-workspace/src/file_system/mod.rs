...
// its wire types live in `sage_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use sage_workspace_types::rpc::fs::FsReadEncoding;
...
pub use sage_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
