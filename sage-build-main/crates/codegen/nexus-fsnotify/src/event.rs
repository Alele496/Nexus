//! Public event types — the wire contract for `sage-fsnotify`.
//!
...
//! translator (in `sage-workspace`) maps these to
...
/// Aligned with `nexus_workspace_types::FsEventKind` (identity map at
